...
JayP - 072024 - MattoStringList for Single Dimension TTensor (bias)
...
uses
  ...
  begin
    ...
    begin
      //WriteLn('Length idx:'+InttoStr(Length(idx))+', NDims: '+InttoStr(Self.NDims));
